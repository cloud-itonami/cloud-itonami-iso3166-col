...
`cloud-itonami-iso3166-col` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
Colombian-licensed counsel or a registered agent for whatever licensed
representation the law of Colombia requires for public-procurement
filings.
