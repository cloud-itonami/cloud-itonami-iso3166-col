(ns marketentry.store
  "SSoT for the COL market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems CO" :portal "SECOP II"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-co-entity? true :has-co-entity? true
             :requires-nit? true :nit-verified? true
             :drafted? false :submitted? false
             :jurisdiction "COL" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "SECOP II"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-co-entity? true :has-co-entity? true
             :requires-nit? true :nit-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "SECOP II"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "COL" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "SECOP II"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-co-entity? true :has-co-entity? false
             :requires-nit? true :nit-verified? true
             :drafted? false :submitted? false
             :jurisdiction "COL" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "SECOP II"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-co-entity? true :has-co-entity? true
             :requires-nit? true :nit-verified? false
             :drafted? false :submitted? false
             :jurisdiction "COL" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "SECOP II"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-co-entity? has-co-entity?
                               requires-nit? nit-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-co-entity?)  (assoc :engagement/requires-co-entity? requires-co-entity?)
    (some? has-co-entity?)       (assoc :engagement/has-co-entity? has-co-entity?)
    (some? requires-nit?)    (assoc :engagement/requires-nit? requires-nit?)
    (some? nit-verified?)    (assoc :engagement/nit-verified? nit-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-co-entity? :engagement/has-co-entity?
   :engagement/requires-nit? :engagement/nit-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-co-entity? (boolean (:engagement/requires-co-entity? m))
     :has-co-entity? (boolean (:engagement/has-co-entity? m))
     :requires-nit? (boolean (:engagement/requires-nit? m))
     :nit-verified? (boolean (:engagement/nit-verified? m))
...
(defn kotobase-store
  ...
  [{:keys [db-api seq-fn]}]
  (->KotobaseStore (persist/store {:db-api db-api :actor "marketentry-col"})
