# cloud-itonami-iso3166-col

Open ISO 3166 Blueprint for **COL**: Colombia.
...
tax registration, and local-content rules in Colombia, so the operator
...
- **Not the government of Colombia.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Colombian-licensed counsel
...
(ISO 3166 `COL`). Required capabilities:
